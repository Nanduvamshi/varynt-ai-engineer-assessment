...
from app.q2_routing.router import generate as q2_generate
...
def gen_q1() -> None:
    ...
    cases = {
        ...
        "q1_classify_incomplete.json": LeadInput(email="someone@example.com"),
    }
...
def gen_q2() -> None:
    ...
    cases = {
        "q2_route_image.json": GenerationRequest(
            modality="image", prompt="modern real-estate hero banner with warm lighting"
        ),
        "q2_route_video.json": GenerationRequest(
            modality="video", prompt="15s testimonial-style intro for a fitness coach"
        ),
        "q2_route_voice.json": GenerationRequest(
            modality="voice", prompt="welcome message in a warm female voice"
        ),
